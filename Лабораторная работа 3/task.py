class Book:
    ...
    def __str__(self):
        ...
        Это представление удобно для конечных пользователей.
        """
    ...
    def __repr__(self):
        ...
        Это представление предназначено для разработчиков.
        """
        return f"{self.__class__.__name__}(name={self.name!r}, author={self.author!r})"


class PaperBook(Book):
    """Класс для бумажных книг. Наследует базовый класс Book."""
    ...
    def __str__(self):
        ...
        Возвращает строковое представление бумажной книги, добавляя информацию о количестве страниц.
        """
...
class AudioBook(Book):
    """Класс для аудиокниг. Наследует базовый класс Book."""
    ...
    def __str__(self):
        """
        Переопределение метода __str__.
        Возвращает строковое представление аудиокниги, добавляя информацию о продолжительности.
        """
